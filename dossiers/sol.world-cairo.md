...
Day length over the year: **10.04 h to 13.90 h**.

Sunrise-azimuth range over the year (the Chankillo span): **62.2° to 117.2°** (ENE to ESE), a swing of 55.1°.
...
Milky Way band: reaches **59.8°** altitude at this site — an arch, passing near overhead, crossing the horizon near WNW and ESE.

Zenith stars (pass within 2° of overhead once per rotation): HIP36850, HIP25428.
...
**6 shared rising houses** (stars rising within the same 5°-wide azimuth bin):
- ~70° (ENE): HIP69673, HIP21421
- ~85° (E): HIP37279, HIP25336
- ~165° (SSE): HIP7588, HIP61084
- ~80° (E): HIP27989, HIP97649
- ~55° (NE): HIP37826, HIP25428
- ~125° (SE): HIP113368, HIP33579

Heliacal rising/setting dates found for 25 of the 30 (calendar-anchor stars; full dates in the appendix).
...
| equinox_1_yr | 0.500 |
| equinox_2_yr | 1.000 |
| min_day_hours | 10.036 |
| max_day_hours | 13.898 |
| min_rise_az_deg | 62.153 |
| max_rise_az_deg | 117.245 |
...
| HIP71683 | -0.010 | 0.710 | 1.347 | never rises |
...
| HIP68702 | 0.610 | -0.231 | 161.031 | never rises |
| HIP97649 | 0.760 | 0.221 | 5.143 | rises and sets |
| HIP60718 | 0.770 | -0.243 | 98.328 | never rises |
...
| HIP71681 | 1.350 | 0.900 | 1.347 | never rises |
...
| HIP45238 | 1.670 | 0.070 | 34.083 | never rises |
...
| --- | --- | --- | --- | --- | --- |
| HIP32349 | 109.407 | 250.593 | rises and sets | 0.283 | 0.275 |
| HIP30438 | 156.765 | 203.235 | rises and sets | 0.367 | 0.163 |
| HIP69673 | 67.692 | 292.308 | rises and sets | 0.071 | 0.738 |
| HIP71683 | — | — | never rises | — | — |
| HIP91262 | 43.647 | 316.353 | rises and sets | 0.188 | 0.925 |
| HIP24608 | 33.802 | 326.198 | rises and sets | 0.083 | 0.346 |
| HIP24436 | 99.486 | 260.514 | rises and sets | 0.212 | 0.229 |
| HIP37279 | 83.961 | 276.039 | rises and sets | 0.287 | 0.350 |
| HIP7588 | 166.273 | 193.727 | rises and sets | 0.225 | 0.958 |
| HIP27989 | 81.435 | 278.565 | rises and sets | 0.217 | 0.279 |
| HIP68702 | — | — | never rises | — | — |
| HIP97649 | 79.741 | 280.259 | rises and sets | 0.292 | 0.917 |
| HIP60718 | — | — | never rises | — | — |
| HIP21421 | 70.836 | 289.164 | rises and sets | 0.142 | 0.242 |
| HIP65474 | 102.922 | 257.078 | rises and sets | 0.083 | 0.642 |
| HIP80763 | 120.946 | 239.054 | rises and sets | 0.221 | 0.754 |
| HIP37826 | 57.125 | 302.875 | rises and sets | 0.254 | 0.404 |
| HIP113368 | 124.820 | 235.180 | rises and sets | 0.546 | 0.971 |
| HIP62434 | 175.785 | 184.215 | rises and sets | 0.242 | 0.329 |
| HIP71681 | — | — | never rises | — | — |
| HIP49669 | 76.141 | 283.859 | rises and sets | 0.367 | 0.500 |
| HIP33579 | 124.026 | 235.974 | rises and sets | 0.313 | 0.258 |
| HIP36850 | 52.392 | 307.608 | rises and sets | 0.237 | 0.408 |
| HIP61084 | 165.951 | 194.049 | rises and sets | 0.188 | 0.371 |
| HIP85927 | 134.179 | 225.821 | rises and sets | 0.283 | 0.771 |
| HIP25336 | 82.660 | 277.340 | rises and sets | 0.196 | 0.258 |
| HIP25428 | 56.418 | 303.582 | rises and sets | 0.154 | 0.300 |
| HIP45238 | — | — | never rises | — | — |
| HIP109268 | 147.601 | 212.399 | rises and sets | 0.571 | 0.896 |
| HIP26727 | 92.244 | 267.756 | rises and sets | 0.221 | 0.258 |
